...
const Test = () => {
  ...
  const ElectionFormA = () => {
    ...
    const addCandidate = () => {
      ...
      if (electionDetails.amountOfCandidates) {
        setElectionDetails((prevDetails) => ({
          ...prevDetails,
      ...
      <>
        <div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {electionDetails.candidates.map((candidate, index) => (
              <div key={index}>
                ...
                <ul>
                  ...
                  <label>Counter</label>
                    <input 
                      value={candidate.voteCounter}
                      onChange={(e) =>
                        handleCandidateChange(index, "voteCounter", e.target.value)
                      }
            ...
            {electionDetails.amountOfCandidates > 0 && (
...
// voiting page with multiple election
