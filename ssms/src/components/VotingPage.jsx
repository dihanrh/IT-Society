...
const CountdownTimer = ({ timeRemaining, startTime }) => {
  if (startTime > new Date().getTime()) {
    ...
    const days = Math.floor(
      (timeRemaining % (1000 * 60 * 60 * 24 * 365)) / (1000 * 60 * 60 * 24)
    );
    const hours = Math.floor(
  ...
  positions: [
    {
      ...
      candidates: [
        ...
        },
        {
          ...
          photo:
            "https://scontent.fdac135-1.fna.fbcdn.net/v/t39.30808-6/342499600_2368984659936847_5811475968911386302_n.jpg?_nc_cat=104&cb=99be929b-3346023f&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeEPQnw80BaOKYsBWC05s_leVlJMt7onJZJWUky3uiclkpsN0bEvRYQqbtvswHLYNT9gsntX2Bfvjq7g-JJP1g3H&_nc_ohc=mENS-qjEoVMAX_QtqMI&_nc_ht=scontent.fdac135-1.fna&oh=00_AfD7e5y8W5lE6aTpZXo4PNaJh13Fv5pz1cfxOCUZuLywZg&oe=64D1EC89",
        },
      ],
    },
    {
      ...
      candidates: [
        {
          ...
          photo:
            "https://scontent.fdac135-1.fna.fbcdn.net/v/t39.30808-6/355865078_824931845723764_8552054937243491595_n.jpg?stp=cp6_dst-jpg&_nc_cat=110&cb=99be929b-3346023f&ccb=1-7&_nc_sid=174925&_nc_eui2=AeHx_mwJMk9uqlk6OJA1VOVbGR33dC9m0PEZHfd0L2bQ8Z-NtvmWZA3nUboRYBSeKz0oTfvXE_rAWRJQ-2cpeOrM&_nc_ohc=WYNBMA6Eq2cAX-go3tZ&_nc_ht=scontent.fdac135-1.fna&oh=00_AfAOL7EFfPVXdUqjOZ1Y1-PtX_iWcxgKIz5FWa85xfiGBg&oe=64D24E76",
        },
        {
          _id: "candidate4",
          name: "Sunny Kazi",
...
const VotingPage = () => {
  ...
  const handleSubmitVotes = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}${API_ENDPOINTS.VOTE}/${election._id}`,
        {
          method: "PUT",
          headers: {
  ...
  if (!studentId) {
    ...
    return (
      <div>
        <h1> No Current Election or Time Over</h1>
      </div>
    );
  }
  ...
  if (hasVoted) {
    return (
      <div className="voting-page">
        <h1>
          You already have voted in this election: {election.electionTitle}
        </h1>
      </div>
    );
  }
  ...
  return (
    <div className="dashboard-links">
      ...
      {voteSubmissionStatus === "success" && <p>Vote Submission Successful!</p>}
      ...
      {voteSubmissionStatus !== "success" && election && !hasVoted && (
        <div className="candidate-section">
          ...
          <button className="buttonVIP" onClick={handleSubmitVotes}>
            Submit
          </button>
        </div>
      )}
